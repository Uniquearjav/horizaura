  ...
  return (
    <>
     ...
     <div class="absolute inset-0 flex flex-col items-center justify-center">
         <h1 class=" md:text-7xl text-7xl lg:text-8xl xl:text-9xl text-white font-bold">Horizaura</h1>
         <p class="text-xl text-white mt-4">Handcrafted treasures, bringing your vision to life with style.</p>
     </div>
 </div>
    ...
    <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
        ...
        <div class="px-4 mx-auto text-center md:max-w-screen-md lg:max-w-screen-lg lg:px-36">
            ...
            <div class="flex flex-wrap justify-center items-center mt-8 text-gray-500 sm:justify-between">
                <a href="#" class="flex items-center mr-5 mb-5 lg:mb-0 hover:text-gray-800 dark:hover:text-gray-400">
...
<section class="bg-white dark:bg-gray-900">
    <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
        <div class="mr-auto place-self-center lg:col-span-7">
            ...
            <a href="/store" class="inline-flex  items-center justify-center px-5 py-3 text-base font-medium text-center text-gray-900 border border-gray-300 rounded-lg hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 dark:text-white dark:border-gray-700 dark:hover:bg-gray-700 dark:focus:ring-gray-800">
                Explore Store
            </a> 
        </div>
        <div class="hidden lg:mt-0 lg:col-span-5 lg:flex">
            <img src="https://m.media-amazon.com/images/I/51IMeXBr+KL.jpg" alt="mockup" />
        </div>                
    </div>
